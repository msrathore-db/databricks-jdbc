...
/**
 * OSS JDBC — SEA (SQL Execution API) Full SPOG Matrix Test.
 *
 * <p>Same scenarios as OssJdbcFullMatrix but with UseThriftClient=0 to route through the SQL
 * Execution API transport instead of Thrift. Usage is identical — see the sibling file.
 */
public class OssJdbcSeaFullMatrix {
  ...
  public static void main(String[] args) {
    System.out.println("================================================================");
    System.out.println("  OSS JDBC — SEA Full SPOG Matrix Test");
    System.out.println("================================================================");
    try {
    ...
    System.out.println("\n================================================================");
    System.out.printf("  SUMMARY (SEA): PASS=%d  FAIL=%d  SKIP=%d%n", pass, fail, skip);
    System.out.println("================================================================");
  ...
  static String url(String host, String path, String auth) {
    return String.format(
        "jdbc:databricks://%s/default;ssl=1;%s;httpPath=%s;UseThriftClient=0", host, auth, path);
  }
